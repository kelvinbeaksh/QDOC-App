...
import useIsTrackEnabled from "../../../hooks/videos/useIsTrackEnabled/useIsTrackEnabled";
...
const AudioLevelIndicator = ({ audioTrack, color = "white" }: { audioTrack?: AudioTrack; color?: string }) => {
