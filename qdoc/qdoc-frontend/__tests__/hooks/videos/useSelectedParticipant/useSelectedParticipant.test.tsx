...
import useSelectedParticipant, { SelectedParticipantProvider }
  from "../../../../src/hooks/videos/useSelectedParticipant/useSelectedParticipant";
...
describe("the useSelectedParticipant hook", () => {
  ...
  it("should not set \"null\" as the selected participant when a " +
    "non-selected participant disconnects from the room", () => {
    act(() => result.current[1]("mockParticipant" as any));
    act(() => {
